...
using System.Linq;
using System.Text;
using NetDimension.Weibo.Entities.place;
...
namespace NetDimension.Weibo.Interface.Entity
{
    public class PlaceInterface: WeiboInterface
    {
		...
		public PlaceInterface(Client client) : base(client)
		{
		...
		{
			return JsonConvert.DeserializeObject(api.PublicTimeline(count,baseApp));
		}
		/// <summary>
		/// 获取当前登录用户与其好友的位置动态  
		/// </summary>
		...
		public dynamic FriendsTimeline(string sinceID = "0", string maxID = "0", int count = 20, int page = 1, int type = 0) {
			return JsonConvert.DeserializeObject(api.FriendsTimeline(sinceID,maxID,count,page,type));
		}
		/// <summary>
		/// 获取某个用户的位置动态 
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.UserTimeline(uid,sinceID,maxID,count,page,baseApp));
		}
		/// <summary>
		/// 获取某个位置地点的动态 
		/// </summary>
		...
		/// <param name="baseApp">是否只获取当前应用的数据。0为否（所有数据），1为是（仅当前应用），默认为0</param>
		/// <returns></returns>
		public IEnumerable<Entities.place.Entity> POITimeline(string poiID, string sinceID = "0", string maxID = "0", int count = 20, int page = 1, bool baseApp = false)
		{
            return JsonConvert.DeserializeObject<IEnumerable<Entities.place.Entity>>(api.POITimeline(poiID, sinceID, maxID, count, page, baseApp));
		}
		/// <summary>
		/// 获取某个位置周边的动态
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.NearByTimeline(lat,log,range,startTime,endTime,sort,count,page,baseApp,offset));
		}
		/// <summary>
		/// 根据ID获取动态的详情
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.StatusesShow(id));
		}
		/// <summary>
		/// 获取LBS位置服务内的用户信息
		/// </summary>
		...
		public dynamic UsersShow(string uid, bool baseApp = false) {
			return JsonConvert.DeserializeObject(api.UsersShow(uid,baseApp));
		}
		/// <summary>
		/// 获取用户签到过的地点列表 
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.UserCheckins(uid,count,page,baseApp));
		}
		/// <summary>
		/// 获取用户的照片列表 
		/// </summary>
		...
		{
            return api.UserPhotos(uid, count, page, baseApp);
		}
		/// <summary>
		/// 获取用户的点评列表 
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.UserTips(uid,count,page,baseApp));
		}
		/// <summary>
		/// 获取用户的todo列表 
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.UserTodos(uid,count,page,baseApp));
		}
		/// <summary>
		/// 获取地点详情 
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.POIShow(poiID,baseApp));
		}
		/// <summary>
		/// 获取在某个地点签到的人的列表
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.POIUsers(poiID,count,page,baseApp));
		}
		/// <summary>
		/// 获取地点点评列表
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.POITips(poiID,count,page,sort,baseApp));
		}
		/// <summary>
		/// 获取地点照片列表 
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.POIPhotos(poiID,count,page,sort,baseApp));
		}
		/// <summary>
		/// 按省市查询地点 
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.POISearch(keyword,city,category,count,page));
		}
		/// <summary>
		/// 获取地点分类 
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.POICategory(pid,flag));
		}
		/// <summary>
		/// 获取附近地点 
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.NearByPOIs(lat,log,range,q,category,count,page,sort,offset));
		}
		/// <summary>
		/// 获取附近发位置微博的人 
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.NearByUsers(lat,log,range,count,page,startTime,endTime,sort,offset));
		}
		/// <summary>
		/// 获取附近照片 
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.NearByPhotos(lat,log,range,count,page,startTime,endTime,sort,offset));
		}
		/// <summary>
		/// 获取附近的人 
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.NearByUserList(lat,log,count,page,range,sort,filter,gender,level,startAge,endAge,offset));
		}
		/// <summary>
		/// 添加地点
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.CreatePOI(title,address,category,lat,log,city,province,country,phone,postcode,extra));
		}
		/// <summary>
		/// 签到同时可以上传一张图片 
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.CheckIn(poiID,status,pic,isPublic));
		}
		/// <summary>
		/// 添加照片 
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.AddPhoto(poiID,status,pic,isPublic));
		}
		/// <summary>
		/// 
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.AddTip(poiID,status,isPublic));
		}
		/// <summary>
		/// 添加todo 
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.AddTodo(poiID,status,isPublic));
		}
		/// <summary>
		/// 用户添加自己的位置 
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.CreateUserPosition(lat,log));
		}
		/// <summary>
		/// 用户删除自己的位置 
		/// </summary>
		...
		{
			return JsonConvert.DeserializeObject(api.DestoryUserPostion());
		}
